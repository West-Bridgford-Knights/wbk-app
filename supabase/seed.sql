...
insert into public.players (id, name, number, pos) values
  ...
  ('p2', 'David Adeyemo', 2, 'MID'),
  ('p3', 'Matthew Blaze', 3, 'MID'),
  ('p4', 'Jacob Brown', 4, 'MID'),
  ('p5', 'Joseph Bullock', 5, 'MID'),
  ('p6', 'Jack Carnell', 6, 'MID'),
  ('p7', 'James Chiu', 7, 'MID'),
  ('p8', 'Tom Cilvert', 8, 'MID'),
  ('p9', 'Ed Cochrane', 9, 'MID'),
  ('p10', 'Harry Cockerham', 10, 'MID'),
  ('p11', 'Mark Coulthard', 11, 'MID'),
  ('p12', 'Nathan Cox', 12, 'MID'),
  ('p13', 'Morgan Davies-Brown', 13, 'MID'),
  ('p14', 'Peter Draper', 14, 'MID'),
  ('p15', 'Harry Eggleston', 15, 'MID'),
  ('p16', 'Harry Fitzjohn', 16, 'MID'),
  ('p17', 'Gregory Hallford', 17, 'MID'),
  ('p18', 'Thomas Harrison', 18, 'MID'),
  ('p19', 'Ben Hawksworth', 19, 'MID'),
  ('p20', 'Daniel Hemmings', 20, 'MID'),
  ('p21', 'Joel Holmes', 21, 'MID'),
  ('p22', 'Harman Khosa', 22, 'MID'),
  ('p23', 'Andrew Kirkwood', 23, 'MID'),
  ('p24', 'Nicholas Kirkwood', 24, 'MID'),
  ('p25', 'Stijn Lenders', 25, 'MID'),
  ('p26', 'Hamish Llewelyn', 26, 'MID'),
  ('p27', 'John Lowe', 27, 'MID'),
  ('p28', 'Tom Marshall', 28, 'MID'),
  ('p29', 'Elliott Matter', 29, 'MID'),
  ('p30', 'Luke Maxted', 30, 'MID'),
  ('p31', 'Declan McNally', 31, 'MID'),
  ('p32', 'Will Rainford', 32, 'MID'),
  ('p33', 'Christopher Ryder', 33, 'MID'),
  ('p34', 'Brandon Vandenhende', 34, 'MID'),
  ('p35', 'Thomas Vasey', 35, 'MID'),
  ('p36', 'Tomoya Wada', 36, 'MID'),
  ('p37', 'Matteo', 37, 'MID'),
  ('p38', 'Alex', 38, 'MID'),
  ('p39', 'Jack', 39, 'MID'),
  ('p40', 'Aiden', 40, 'MID'),
  ('p41', 'David Nice', 41, 'MID'),
  ('p42', 'Ross Whiting', 42, 'MID');
